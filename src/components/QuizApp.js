...
export class QuizApp {
    ...
    random() { this.isAnswered=false; audioService.stop(); this.currentData=quizService.generateQuestion(null); this.render(); }
    next(id=null) { 
    ...
    render() {
        ...
        if(!this.currentData) { 
            this.container.innerHTML = headerHTML + `<div class="p-10 text-center text-white pt-24">Not enough vocabulary (Need 4+).</div>`;
